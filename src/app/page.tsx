...
import { Search, MapPin, Star, Heart, TrendingUp, Sparkles, Navigation } from 'lucide-react';
              ...
              <Card className="border-purple-100">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                      <Link href="/dashboard/customer/messages" className="flex items-center">
                        <span className="font-medium text-warmgray-900 mr-1">3</span>
                      </Link>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
